...
import {} from '../../../pure/bonds/bond/schema';
import { BondsApiSchema } from '../../../pure/bonds/bonds/schema';
export function getBondFromSubgraph(args) {
    return __awaiter(this, void 0, void 0, function () {
        var bondsArgs, bond;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bondsArgs = BondsApiSchema.parse({
                        ids: getMarketIdFromChainIdAuctioneerMarket(args.marketId),
                        chainIds: String(args.marketId.chainId),
                        anyIssuer: 'true',
                        onlyOpen: 'false',
                    });
                    return [4 /*yield*/, getBondsFromSubgraph(bondsArgs)];
                case 1:
                    bond = (_a.sent())[0];
                    return [2 /*return*/, bond];
            }
        });
    });
}
