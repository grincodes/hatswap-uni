...
export function getSteerVaultsFromDB(args) {
    return __awaiter(this, void 0, void 0, function () {
        var take, orderBy, where, skip, cursor, client, vaults, vaultsRetyped;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    client = _b.sent();
                    return [4 /*yield*/, client.steerVault.findMany(__assign(__assign({ take: take, skip: skip }, cursor), { where: where, orderBy: orderBy, select: {
                                id: true,
                                address: true,
                                chainId: true,
                                pool: {
                ...
                case 2:
                    vaults = _b.sent();
                    vaultsRetyped = vaults;
                    return [4 /*yield*/, client.$disconnect()];
                case 3:
                    _b.sent();
                    return [2 /*return*/, vaultsRetyped];
            }
        });
    });
}
