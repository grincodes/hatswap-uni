import { type GetBondArgs } from '../../pure/bonds/bond/bond';
import { type SWRHookConfig } from '../../types';
export declare const useBond: ({ args, shouldFetch }: SWRHookConfig<GetBondArgs>) => import("swr/_internal").SWRResponse<{
