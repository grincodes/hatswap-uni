import { type GetSteerVaultsArgs } from '../../pure/steer-vault/vaults/vaults';
import { type SWRHookConfig } from '../../types';
export declare const useSteerVaults: ({ args, shouldFetch, }: SWRHookConfig<GetSteerVaultsArgs>) => import("swr/_internal").SWRResponse<import("@sushiswap/database").DecimalToString<{
    id: string;
    address: string;
    chainId: number;
    token1: {
