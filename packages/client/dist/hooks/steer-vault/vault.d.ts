import { type GetSteerVaultArgs } from '../../pure/steer-vault/vault/vault';
import { type SWRHookConfig } from '../../types';
export declare const useSteerVault: ({ args, shouldFetch, }: SWRHookConfig<GetSteerVaultArgs>) => import("swr/_internal").SWRResponse<import("@sushiswap/database").DecimalToString<{
    id: string;
    address: string;
    chainId: number;
    token1: {
