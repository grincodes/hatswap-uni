...
export declare function getMarketPricesContracts({ marketIds, }: {
    marketIds: MarketId[];
}): {
    abi: readonly [{
...
export declare function getMarketsPrices({ client, marketIds, }: GetMarketsPrices): Promise<{
...
export declare function getMarketPrice({ client, marketId }: GetMarketPrice): Promise<{
    marketId: `1:0x${string}:${number}` | `1:0x${string}:${bigint}` | `137:0x${string}:${number}` | `137:0x${string}:${bigint}` | `42161:0x${string}:${number}` | `42161:0x${string}:${bigint}` | `10:0x${string}:${number}` | `10:0x${string}:${bigint}`;
    marketPrice: bigint;
} | undefined>;
export {};
