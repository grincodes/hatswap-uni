...
export declare function getRemainingCapacitiesContracts({ marketIds, }: {
    marketIds: MarketId[];
}): {
    abi: readonly [{
...
export declare function getRemainingCapacities({ client, marketIds, }: GetRemainingCapacities): Promise<{
...
export declare function getRemainingCapacity({ client, marketId, }: GetRemainingCapacity): Promise<{
    marketId: `1:0x${string}:${number}` | `1:0x${string}:${bigint}` | `137:0x${string}:${number}` | `137:0x${string}:${bigint}` | `42161:0x${string}:${number}` | `42161:0x${string}:${bigint}` | `10:0x${string}:${number}` | `10:0x${string}:${bigint}`;
    remainingCapacity: bigint;
} | undefined>;
export {};
