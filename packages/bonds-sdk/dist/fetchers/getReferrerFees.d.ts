...
export declare function getReferrerFeesContracts({ args }: {
    args: Args[];
}): {
    abi: readonly [{
...
export declare function getReferrerFees({ client, args }: GetReferrerFees): Promise<{
    referrerId: string;
    tellerId: string;
    referrerFee: number;
}[]>;
...
export declare function getReferrerFee({ client, arg }: GetReferrerFee): Promise<{
    referrerId: string;
    tellerId: string;
    referrerFee: number;
} | undefined>;
