...
export declare function getMaxAmountsAcceptedContracts({ marketIds, referrer, }: Omit<GetMaxAmountsAccepted, 'client'>): {
    abi: readonly [{
...
export declare function GetMaxAmountsAccepted({ client, marketIds, referrer, }: GetMaxAmountsAccepted): Promise<{
...
export declare function getMaxAmountAccepted({ client, marketId, referrer, }: GetMaxAmountAccepted): Promise<{
    marketId: `1:0x${string}:${number}` | `1:0x${string}:${bigint}` | `137:0x${string}:${number}` | `137:0x${string}:${bigint}` | `42161:0x${string}:${number}` | `42161:0x${string}:${bigint}` | `10:0x${string}:${number}` | `10:0x${string}:${bigint}`;
    maxAmountAccepted: bigint;
} | undefined>;
export {};
