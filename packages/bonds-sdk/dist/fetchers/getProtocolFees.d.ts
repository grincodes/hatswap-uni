...
export declare function getProtocolFeesContracts({ tellerIds, }: {
    tellerIds: string[];
}): {
    abi: readonly [{
...
export declare function getProtocolFees({ client, tellerIds }: GetProtocolFees): Promise<{
    tellerId: string;
    protocolFee: number;
}[]>;
...
export declare function getProtocolFee({ client, tellerId }: GetProtocolFee): Promise<{
    tellerId: string;
    protocolFee: number;
} | undefined>;
export {};
