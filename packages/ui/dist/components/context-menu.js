...
const ContextMenuLabel = React.forwardRef((_a, ref) => {
    var { className, inset } = _a, props = __rest(_a, ["className", "inset"]);
    return (_jsx(ContextMenuPrimitive.Label, Object.assign({ ref: ref, className: classNames('px-2 py-1.5 text-sm font-semibold text-foreground', inset && 'pl-8', className) }, props)));
});
ContextMenuLabel.displayName = ContextMenuPrimitive.Label.displayName;
const ContextMenuSeparator = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(ContextMenuPrimitive.Separator, Object.assign({ ref: ref, className: classNames('-mx-1 my-1 h-px bg-border', className) }, props)));
});
