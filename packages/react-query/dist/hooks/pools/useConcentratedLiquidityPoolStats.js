...
export const useConcentratedLiquidityPoolStats = ({ chainId, address, enabled = true, }) => {
    return useQuery({
            ...
            if (data) {
                return {
                    ...
                    incentives: data.incentives.map((incentive) => {
                        ...
                        return {
                            ...incentive,
                            reward: Amount.fromRawAmount(rewardToken, parseUnits(incentive.rewardPerDay.toString(), incentive.rewardToken.decimals)),
                        };
                    }),
                };
            }
...
//# sourceMappingURL=useConcentratedLiquidityPoolStats.js.map