...
> = {
  ...
  //todo: v3 factory
  [ChainId.DEGEN]: '0x126555dd55a39328F69400d6aE4F782Bd4C34ABb',
...
> = {
  ...
  [ChainId.DEGEN]: '0x2214A42d8e2A1d20635c2cb0664422c528B6A432',
...
export const SUSHISWAP_V3_TICK_LENS: Record<SushiSwapV3ChainId, `0x${string}`> =
  {
    ...
    //todo degen
    [ChainId.DEGEN]: '0xFB70AD5a200d784E7901230E6875d91d5Fa6B68c',
