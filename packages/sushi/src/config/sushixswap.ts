...
export const SUSHIXSWAP_ADDRESS: Record<SushiXSwapChainId, `0x${string}`> = {
  ...
  //todo degen
  [ChainId.DEGEN]: '0x011E52E4E40CF9498c79273329E8827b21E2e581',
...
export const SUSHIXSWAP_2_ADDRESS: Record<SushiXSwap2ChainId, `0x${string}`> = {
  ...
  //todo degen
  [ChainId.DEGEN]: '0x804b526e5bf4349819fe2db65349d0825870f8ee',
...
> = {
  ...
  //todo degen
   [ChainId.DEGEN]: '0xD408a20f1213286fB3158a2bfBf5bFfAca8bF269',
