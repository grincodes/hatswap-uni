...
exports.WNATIVE = {
    ...
    [index_js_1.ChainId.DEGEN]: new Token_js_1.Token({
        chainId: index_js_1.ChainId.DEGEN,
        address: token_addresses_js_1.WNATIVE_ADDRESS[index_js_1.ChainId.DEGEN],
        decimals: 18,
        symbol: 'DEGEN',
        name: 'Wrapped DEGEN',
    }),
...
exports.DEGEN = addressMapToTokenMap({
    decimals: 18,
    symbol: 'DEGEN',
    name: 'DEGEN',
}, token_addresses_js_1.DEGEN_ADDRESS);
