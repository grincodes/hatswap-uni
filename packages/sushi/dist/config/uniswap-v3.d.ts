...
export declare const UNISWAP_V3_SUPPORTED_CHAIN_IDS: readonly [42161, 666666666, 56, 42220, 1, 10, 137, 8453, 1284, 43114];
export declare const UniswapV3ChainIds: readonly [42161, 666666666, 56, 42220, 1, 10, 137, 8453, 1284, 43114];
export type UniswapV3ChainId = (typeof UNISWAP_V3_SUPPORTED_CHAIN_IDS)[number];
export declare const isUniswapV3ChainId: (chainId: ChainId) => chainId is 1 | 137 | 56 | 666666666 | 42161 | 43114 | 42220 | 1284 | 10 | 8453;
