...
exports.publicTransports = {
    ...
    [index_js_1.ChainId.ZETACHAIN]: (0, viem_1.http)('https://zetachain-mainnet-archive.allthatnode.com:8545'),
...
exports.SpecialExtractorClientConfig = {
    [index_js_1.ChainId.BSC]: {
        chain: chains_1.bsc,
        transport: (0, viem_1.http)(`https://lb.drpc.org/ogrpc?network=bsc&dkey=${drpcId}`, {
            timeout: 120000,
        }),
    },
    [index_js_1.ChainId.ETHEREUM]: {
        chain: chains_1.mainnet,
        transport: (0, viem_1.http)(`https://lb.drpc.org/ogrpc?network=ethereum&dkey=${drpcId}`, {
            timeout: 120000,
        }),
    },
    [index_js_1.ChainId.FILECOIN]: {
        chain: exports.filecoin,
        transport: (0, viem_1.http)(`https://lb.drpc.org/ogrpc?network=filecoin&dkey=${drpcId}`, {
            timeout: 120000,
        }),
    },
};
